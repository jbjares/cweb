 ...
 */
public class CwebTaskBar extends LayoutContainer {
...
class StartButton extends Button {
	...
	public StartButton() {
		...
		if (super.template == null)
			super.template = new Template(getButtonTemplate());
	}
	...
	private String getButtonTemplate() {
		...
		sb.append("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"x-btn-wrap\"><tbody><tr>");
		sb.append("<td class=\"ux-startbutton-left\"><i>&#160;</i></td><td class=\"ux-startbutton-center\"><em unselectable=\"on\">");
		sb.append("<button class=\"x-btn-text\" id=\"id_CwebTaskBar_startBtn\" type=\"{1}\" style=\"height:30px;\">{0}</button>");
		sb.append("</em></td><td class=\"ux-startbutton-right\"><i>&#160;</i></td>");
...
class TaskButton extends Button {
	...
	private String getButtonTemplate() {
		...
		StringBuffer sb = new StringBuffer();
		sb.append("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"x-btn-wrap\"><tbody><tr>");
		sb.append("<td class=\"ux-taskbutton-left\"><i>&#160;</i></td><td class=\"ux-taskbutton-center\"><em unselectable=\"on\">");
		sb.append("<button class=\"x-btn-text\" type=\"{1}\" style=\"height:28px;\">{0}</button>");
		sb.append("</em></td><td class=\"ux-taskbutton-right\"><i>&#160;</i></td>");
		sb.append("</tr></tbody></table>");
...
class TasksButtonsPanel extends BoxComponent {
	...
	private void autoSize() {
		...
		int each = (int) Math.max(Math.min(Math.floor((aw - 4) / count)
				- buttonMargin, buttonWidth), minButtonWidth);
		NodeList<com.google.gwt.dom.client.Element> btns = stripWrap.dom
