...
public class TriggerFieldClear<D> extends TextField<D> {

	  protected BaseEventPreview focusEventPreview;
	  protected El trigger;
	  protected El clearTrigger;
	  protected String triggerStyle = "x-form-trigger-arrow";
	  protected String clearTriggerStyle = "x-form-clear-trigger-arrow";
	  ...
	  public void onComponentEvent(ComponentEvent ce) {
	    ...
	    if (ce.getTarget() == clearTrigger.dom && type == Event.ONCLICK && !readOnly) {
	    	onClearTriggerClick(ce);
		}
	  }
	...
	public String getClearTriggerStyle() {
		return clearTriggerStyle;
	}

	public void setClearTriggerStyle(String clearTriggerStyle) {
		this.clearTriggerStyle = clearTriggerStyle;
	}
