...
public class SimplePager_Resources_pt_BR_InlineClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  private static SimplePager_Resources_pt_BR_InlineClientBundleGenerator _instance0 = new SimplePager_Resources_pt_BR_InlineClientBundleGenerator();
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".GALD-WOMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GALD-WOKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GALD-WOLF{cursor:" + ("default")  + ";}");
      }
