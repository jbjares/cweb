...
public class Usuario_Array_Rank_1_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  ...
  public static br.com.cweb.seguranca.persistence.entity.Usuario[] instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    return new br.com.cweb.seguranca.persistence.entity.Usuario[size];
  }
  ...
  public Object create(SerializationStreamReader reader) throws SerializationException {
    return br.com.cweb.seguranca.persistence.entity.Usuario_Array_Rank_1_FieldSerializer.instantiate(reader);
  }
  
  public void deserial(SerializationStreamReader reader, Object object) throws SerializationException {
    br.com.cweb.seguranca.persistence.entity.Usuario_Array_Rank_1_FieldSerializer.deserialize(reader, (br.com.cweb.seguranca.persistence.entity.Usuario[])object);
  }
  
  public void serial(SerializationStreamWriter writer, Object object) throws SerializationException {
    br.com.cweb.seguranca.persistence.entity.Usuario_Array_Rank_1_FieldSerializer.serialize(writer, (br.com.cweb.seguranca.persistence.entity.Usuario[])object);
  }
